...
Min.MouseButton1Click:Connect(function()
    game.StarterGui:SetCore("SendNotification", {
        Title = "Volt;
        Text = "Volt hide. Press F6 to back.";
        Duration = 2;
    })
    MainFrame.Visible = false
    synminbutt.Visible = false
...
execute.MouseButton1Click:Connect(function()
    ...
    if injected == false then
        title.Text = "Volt - (Not injected! Press attach)"
    end
end)
...
Attach.MouseButton1Click:Connect(function()
    if injected == true then
        title.Text = "Volt - (Already injected!)"
        wait(1)
        title.Text = "Volt - (Injected)"
    end
    if injected == false then
        title.Text = "Volt - (Checking...)"
        wait(0.1)
        title.Text = "Volt - (Injecting...)"
        wait(1.5)
        title.Text = "Volt - (Checking Whitelist...)"
        wait(0.8)
        title.Text = "Volt - (Scanning...)"
        wait(0.3)
        title.Text = "Volt - (Ready!)"
        wait(0.5)
        title.Text = "Volt - (Injected)"
        injected = true
    end
...
synapsex3.MouseButton1Click:Connect(function()
    game.StarterGui:SetCore("SendNotification", {
        Title = "Volt";
        Text = "Volt v3 coming soon.";
        Duration = 1;
    })
    synapsex3.Text = "Coming soon."
    wait(1)
    synapsex3.Text = "Volt v3"
end)
